...
?>
<nav class="navbar bg-dark navbar-dark navbar-expand-lg bg-body-tertiary" data-bs-theme="dark">
    <div class="container-fluid">
        ...
        <?php }else{?>
            <!--
            <a href="<?php //echo $_ENV["app_root"];?>services/oAuth/init-oauth.php" id="loginWithDiscord_btn">
